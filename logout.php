				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="sidebar-left.html">Buat Laporan</a></li>
							<li class="active"><a href="sidebar-right.html">Progress Laporan</a></li>
						</ul>
					</li>
	...
	<div class="container text-center">
		...
		<p class="text-muted">
            <p class="tagline">
                ...
                <a class="btn btn-action btn-lg" role="button" name="logout" href="signin.php?logout">Logout</a>
				<?php
				require "function.php";
				session_start();

				// Hapus sesi yang sesuai, misalnya 'email'
				if (isset($_SESSION['email'])) {

					// Catat aktivitas logout
					$userId = $pw['id_user']; // Ambil ID pengguna dari database
					$userId = $_SESSION['user_id']; // Gantilah dengan cara Anda mengambil ID pengguna yang berhasil logout
					$activityType = "Logout";
					$activityDescription = "Pengguna dengan ID $userId berhasil logout pada " . date('Y-m-d H:i:s');
					...
					?>
            <p>
                Silakan <a href="signin.php">login</a> untuk melihat informasi penting.
            </p>
		</p>
	</div>
	<!-- /Intro-->
